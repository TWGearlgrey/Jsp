...
public class AuthEmailController extends HttpServlet {
	...
	private static final long serialVersionUID = 2119773056823325384L;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(type.equals("REGISTER")) {
			...
			// 아이디 찾기 할 때 이메일 인증
			//result = service.selectCountNameAndEmail(name, email); <~~ 구현 후 주석 풀기
			...
			// 비밀번호 찾기 할 때 이메일 인증
			//result = service.selectCountUidAndEmail(uid, email); <~~ 구현 후 주석 풀기
