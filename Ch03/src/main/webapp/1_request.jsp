...
<html>
	<head>
		...
		<!--
			...
			GET 방식
			 - 기본 데이터 전송 방식
			 - 전송 데이터가 주소에 노출 (~> 브라우저 히스토리에 남기때문에 보안에 취약)
			 
			POST 방식
			 - 전송 데이터가 요청 객체(request) body에 삽입되어 전송
			 - 전송 데이터 노출 안 됨
	...
	<body>
		...
		<form action="./proc/registerProc.jsp" method="post">
			<table border="1">
				<tr>
					<td>아이디</td>
					<td><input type="text" name="uid" placeholder="아이디 입력"/><br></td>
				</tr>
				<tr>
					<td>비밀번호</td>
					<td><input type="password" name="pass" placeholder="비밀번호 입력"/><br></td>
				</tr>
				<tr>
					<td>이름</td>
				...
				<tr>
					<td>생년월일</td>
					<td><input type="date" name="birth" placeholder="생년월일 선탟"/><br></td>
				</tr>
				<tr>
					<td>성별</td>
					<td>
